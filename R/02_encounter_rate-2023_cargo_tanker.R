...
v.ship <- c(v.ship,rep(5.144,times=750)) ; l.ship # add projected traffic speeds, 10 knots or 0.5144 m/s
l.ship = traffic$length ; l.ship
l.ship <- l.ship[l.ship > 0] ; l.ship
l.ship <- c(l.ship,rep(300,times=750)) ; l.ship # add projected traffic
