...
bootci(mrs$encounters)
```

```{r,eval=FALSE}
par(mfrow=c(2,2))
par(mar=c(4.2,4.2,1,1))
hist(mrs$encounters, main='Imminent encounter rates',breaks=20) 

hist(mrs$proximities$proximity_m,
     breaks=20,
     main="Nearest proximity during each co-occurrence")

hist(mrs$proximities$whale_hdg,
     breaks=20,
     main="Whale heading at nearest proximity")

hist(mrs$proximities$ship_hdg,
     breaks=20,
     main="Vessel heading at nearest proximity")

speed_ratio <- mrs$proximities$ship_ms / mrs$proximities$whale_ms
hist(speed_ratio,
     breaks=20,
